...
# """REMINDER: Need to put (1-d) in q3."""


# cost_lists = [[5, 20, 25, 30], [5, 20, 25, 30], [5, 20, 25, 30], [5, 20, 25, 30]]
# f_lists = [[0.5, 0.5, 0.5, 0.5], [0.5, 0.5, 0.5, 0.5]]
...
#                 5: [False, 3, False, False]}

# graph_ordered_dict = {0: [2, 'False', 'False', 'False'],
...
def q3(G, node_list, dim, graph_ordered_dict, runtime, run, cost_lists, lembda1=0.7, lembda2=0.3, buff=4):
    q3 = np.zeros((dim, dim))
    ...
    for i in range(len(node_list)):
        ...
        # print("Distances List: ", distance_list)
        # print("speeds list: ", speed_list)
        # print("run time list: ", runtime_list)
...
# for i in range(1, 6):
#
#     q3(G, node_list_, dim, graph_ordered_dict, 5, i)
...
#                         # print("PERCOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ", abs(runtime_list[0] - run))
#                         if not (I_ == 'False' or nm_list[0] == 'False'):
#                             q3[I_][nm_list[0]] -= lembda1 * q1_coeff_[j]
#
#                 if runtime_list[0] <= run:
#                     if run % runtime_list[0] <= buff:
#                         if not (I_ == 'False' or nm_list[0] == 'False'):
...
#                         # print("PERCOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ", abs(runtime_list[1] - run))
#                         if not (I_ == 'False' or nm_list[1] == 'False'):
#                             q3[I_][nm_list[1]] -= lembda2 * q1_coeff_[j]
#
#                 if runtime_list[1] <= run:
#                     if run % runtime_list[1] <= buff:
#                         # print("PERCOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ", abs(runtime_list[1] - run))
...
#                         # print("PERCOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ", abs(runtime_list[2] - run))
#                         if not (I_ == 'False' or nm_list[2] == 'False'):
#                             q3[I_][nm_list[2]] -= lembda1 * q1_coeff_[j]
#
#                 if runtime_list[2] <= run:
#                     if run % runtime_list[2] <= buff:
#                         # print("PERCOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ", abs(runtime_list[2] - run))
...
#                         # print("PERCOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ", abs(runtime_list[3] - run))
#                         if not (I_ == 'False' or nm_list[3] == 'False'):
#                             q3[I_][nm_list[3]] -= lembda2 * q1_coeff_[j]
#
#                 if runtime_list[3] <= run:
#                     if run % runtime_list[3] <= buff:
#                         # print("PERCOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ", abs(runtime_list[3] - run))
...
def Q(G, graph_ordered_dict, cost_lists, lembda, runtime, run, first_time):
    ...
    # q_1_max_value = np.average(q_1)
    # q_1_max_value = q_1[q_1.nonzero()].mean()
    # print("Q1 max value: ", q_1_max_value)
    # print(q_1)

    if not first_time:
        q_3 = q3(G, node_list_, dim, graph_ordered_dict, runtime, run, cost_lists)

        # return q_1 + q_2 + q_3

        # return q_1 + q_2

        # return q_1 + q_2 - q_1_max_value * q_3
        # return q_1 + q_2 + 50* q_3

        return q_1 + q_2 + 60*q_3
