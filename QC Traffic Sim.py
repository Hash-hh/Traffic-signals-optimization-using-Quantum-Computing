...
def Run():
    ...
    tkinter.Label(window, text="Simulation Successfully Completed! Please email us the OUTPUT.txt file "
                                 "generated in the program folder. Thank you!").grid(row=7)
...
tkinter.Label(window, text = "If no token is entered, the program will just run classically using D-Wave QBSolve.").grid(row=1)
...
tkinter.Label(window, text = "When the simulation is complete, please email us the OUTPUT.txt file generated in the program folder. Thank you!").grid(row=4)
